...
%
%  Copyright (C) 2006-2016 Matthias Scholz   
...
% h.plotting
    if isempty(h.plotting), h.plotting='no'; end
...
% for debugging only
  ...
  t_last=ones(1,6)*0.01; % initialisation: step width of the last n steps
for i=1:ITMAX 
