...
SetupStruc.mic_pos = [1.55  1  1.3;    % [x y z] positions of a microphone array in m
                      1.45  1  1.3];
      
SetupStruc.src_traj = [ones(101,1)*1  ones(101,1)*2 ones(101,1)*1.3];   % [x y z] positions of source trajectory in m. 
